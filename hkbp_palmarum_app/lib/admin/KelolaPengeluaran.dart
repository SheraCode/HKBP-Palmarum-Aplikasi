...
class _KelolaPemasukanState extends State<KelolaPengeluaran> {
  ...
  Future<void> fetchData() async {
    try {
      final Uri url = Uri.parse('http://192.168.11.31:2005/pengeluaran/${widget.idPemasukan}');
  ...
  Future<void> _updateKegiatan() async {
    try {
      ...
      var url = 'http://192.168.11.31:2005/pengeluaran';
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Bukti Pengeluaran',
                          style: TextStyle(
                            fontSize: 20, // Ukuran teks sesuai kebutuhan
                            fontWeight: FontWeight.bold, // Gaya teks sesuai kebutuhan
                          ),
                        ),
                        SizedBox(height: 20,),
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: _image != null
                              ...
                              child: Image.file(
                                ...
                                : ClipOval(
                              child: Image.network(
                                'http://192.168.11.31:2005/pengeluaran/image/$idPemasukan',
                                height: 100,
                                width: 100,
                                fit: BoxFit.cover,
                              ),
